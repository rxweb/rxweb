...
import { MacCompleteTemplateDrivenComponent } from "src/assets/examples/reactive-form-validators/template-driven/mac/complete/mac-complete.component";
...
import { MacConditionalExpressionTemplateDrivenComponent } from "src/assets/examples/reactive-form-validators/template-driven/mac/conditionalExpression/mac-conditional-expression.component";
...
import { MacMessageTemplateDrivenComponent } from "src/assets/examples/reactive-form-validators/template-driven/mac/message/mac-message.component";
...
import { MacAddTemplateDrivenComponent } from "src/assets/examples/reactive-form-validators/template-driven/mac/add/mac-add.component";
...
export const MAC_COMPONENT_EXAMPLE_CONSTANT: { [key: string]: any } = {
	...
	template_driven:{
						complete : MacCompleteTemplateDrivenComponent,
						conditionalExpression : MacConditionalExpressionTemplateDrivenComponent,
						message : MacMessageTemplateDrivenComponent,
						add : MacAddTemplateDrivenComponent,
			  },
}