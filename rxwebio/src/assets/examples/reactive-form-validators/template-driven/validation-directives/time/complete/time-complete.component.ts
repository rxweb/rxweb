...
@Component({
    selector: 'app-time-complete-template-driven-validation-directives',
    templateUrl: './time-complete.component.html'
})
export class TimeCompleteTemplateDrivenValidationDirectivesComponent implements OnInit {
