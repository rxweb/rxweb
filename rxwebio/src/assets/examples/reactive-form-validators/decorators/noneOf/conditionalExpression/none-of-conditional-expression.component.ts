...
export class NoneOfConditionalExpressionComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.http.get("assets/examples/reactive-form-validators/decorators/noneOf/conditionalExpression/none-of.json?v="+environment.appVersion).subscribe(response => {
