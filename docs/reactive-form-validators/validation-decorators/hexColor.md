...
<ol>
    ...
    <li>AApply hexColor validation dynamically based on server rules.</li>
</ol>
...
<div component="app-hexColor-add" title="hexColor Decorator for add Example"></div>
# [Edit](#tab\basicedit)
...
<div component="app-hexColor-add" title="hexColor Decorator for edit Example"></div>
***
</data-scope>
...
<div component="app-note" key="hexColor-conditionalExpressionExampleFunction-model"></div>
<div component="app-code" key="hexColor-conditionalExpressionExampleFunction-model"></div> 
<div component="app-note" key="hexColor-conditionalExpressionExampleString-model"></div> 
...
<div component="app-hexColor-complete"></div>
<data-scope scope="['decorator']">
# [Model](#tab\compl1
etemodel)
...
<div component="app-hexColor-dynamic"></div>
<data-scope scope="['decorator']">
