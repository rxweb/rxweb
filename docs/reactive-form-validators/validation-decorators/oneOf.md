...
<div component="app-oneOf-add" title="oneOf Decorator for add Example"></div>
# [Edit](#tab\basicedit)
...
<div component="app-oneOf-add" title="oneOf Decorator for edit Example"></div>
***
</data-scope>
...
<div component="app-note" key="oneOf-conditionalExpressionExampleFunction-model"></div>
<div component="app-code" key="oneOf-conditionalExpressionExampleFunction-model"></div> 
<div component="app-note" key="oneOf-conditionalExpressionExampleString-model"></div> 
...
<div component="app-oneOf-complete"></div>
<data-scope scope="['decorator']">
...
<div component="app-oneOf-dynamic"></div>
<data-scope scope="['decorator']">
