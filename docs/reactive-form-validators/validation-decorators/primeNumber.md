---
title: primeNumber
description: primeNumber validation decorator allows user to enter only the prime number.
...
[!TabGroup]
# [Add](#tab\basicadd)
[!code-typescript[](\assets\examples\reactive-form-validators\decorators\primeNumber\add\prime-number-add.component.ts?type=section)]
# [Edit](#tab\basicedit)
[!code-typescript[](\assets\examples\reactive-form-validators\decorators\primeNumber\edit\prime-number-edit.component.ts?type=section)]
***
