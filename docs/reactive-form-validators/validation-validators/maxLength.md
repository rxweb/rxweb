---
title: maxLength 
description: MaxLength validation validator will allow only maximum length be entered upto value parameter, If user tries to enter any string that length exceed then the value then the property will become invalid
