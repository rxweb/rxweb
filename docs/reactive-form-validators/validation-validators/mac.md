...
[!code-typescript[](\assets\examples\validators\mac\add\mac-add.component.ts)]
***

Next, we need to write html code.
[!code-typescript[](\assets\examples\validators\mac\add\mac-add.component.html)]
...
[!code-typescript[](\assets\examples\validators\mac\conditionalExpression\user.model.ts)]
# [Component](#tab\conditionalExpressionComponent)
[!code-typescript[](\assets\examples\validators\mac\conditionalExpression\mac-conditional-expressions.component.ts)]
# [Html](#tab\conditionalExpressionHtml)
[!code-typescript[](\assets\examples\validators\mac\conditionalExpression\mac-conditional-expressions.component.html)]
***
...
[!code-typescript[](\assets\examples\validators\mac\message\user.model.ts)]
# [Component](#tab\messageComponent)
[!code-typescript[](\assets\examples\validators\mac\message\mac-message.component.ts)]
# [Html](#tab\messageHtml)
[!code-typescript[](\assets\examples\validators\mac\message\mac-message.component.html)]
***
...
[!code-typescript[](\assets\examples\validators\mac\complete\user.model.ts)]
# [Component](#tab\completecomponent)
[!code-typescript[](\assets\examples\validators\mac\complete\mac-complete.component.ts)]
# [Html](#tab\completehtml)
[!code-typescript[](\assets\examples\validators\mac\complete\mac-complete.component.html)]
***
...
[!code-typescript[](\assets\examples\validators\mac\dynamic\user.model.ts)]
# [Component](#tab\dynamiccomponent)
[!code-typescript[](\assets\examples\validators\mac\dynamic\mac-dynamic.component.ts)]
# [Html](#tab\dynamichtml)
[!code-typescript[](\assets\examples\validators\mac\dynamic\mac-dynamic.component.html)]
***