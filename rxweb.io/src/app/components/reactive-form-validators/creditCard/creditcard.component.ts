...
export class CreditCardComponent implements OnInit {
  ...
  codeContent:any = {};
  sidebarLinks:any = {"When to use":null,"Basic CreditCard Validation":null,"CreditCardConfig":["creditCardTypes","conditionalExpression","message"],"Complete CreditCard Example":null};
