...
@NgModule({
  imports: [
    ENDS_WITH_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, EndsWithDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
