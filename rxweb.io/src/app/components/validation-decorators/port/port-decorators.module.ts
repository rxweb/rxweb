...
@NgModule({
  imports: [
    PORT_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, PortDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
