...
@NgModule({
  imports: [
    MIN_DATE_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, MinDateDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
