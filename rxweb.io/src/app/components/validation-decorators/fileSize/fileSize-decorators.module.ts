...
@NgModule({
  imports: [
    FILE_SIZE_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, FileSizeDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
