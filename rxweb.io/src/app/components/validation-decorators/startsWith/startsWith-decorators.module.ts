...
@NgModule({
  imports: [
    STARTS_WITH_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, StartsWithDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
