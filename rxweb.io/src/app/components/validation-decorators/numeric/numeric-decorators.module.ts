...
@NgModule({
  imports: [
    NUMERIC_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, NumericDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
