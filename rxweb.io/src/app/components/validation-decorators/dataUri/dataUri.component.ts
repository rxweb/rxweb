...
export class DataUriComponent implements OnInit {
  ...
  codeContent:any = {};
  sidebarLinks:any = {"dataUri":null,"When to use":null,"Basic dataUri Validation":null,"BaseConfig":["conditionalExpression","message"],"Complete dataUri Example":null,"Dynamic dataUri Example":null};
  ...
  ngOnInit(): void {
	this.http.get('assets/examples/reactive-form-validators/decorators/dataUri/datauri.json',this.options).subscribe((response:object) => {
