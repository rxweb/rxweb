...
@NgModule({
  imports: [
    LATITUDE_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, LatitudeDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
