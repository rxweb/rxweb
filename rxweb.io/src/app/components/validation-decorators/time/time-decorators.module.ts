...
@NgModule({
  imports: [
    TIME_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, TimeDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
