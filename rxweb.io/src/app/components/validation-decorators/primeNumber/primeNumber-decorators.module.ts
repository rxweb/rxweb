...
import { PrimeNumberExtendedModule } from 'src/assets/examples/reactive-form-validators/decorators/primeNumber/primeNumber.module';
...
export class PrimeNumberDecoratorsModule { }
