...
@NgModule({
  imports: [
    HEX_COLOR_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, HexColorDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
