...
@NgModule({
  imports: [
    REQUIRED_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, RequiredDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
