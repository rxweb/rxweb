...
export class LongitudeComponent implements OnInit {
  ...
  codeContent:any = {};
  sidebarLinks:any = {"longitude":null,"When to use":null,"Basic longitude Validation":null,"BaseConfig":["conditionalExpression","message"],"Complete longitude Example":null,"Dynamic longitude Example":null};
  ...
  ngOnInit(): void {
	this.http.get('assets/examples/reactive-form-validators/decorators/longitude/longitude.json',this.options).subscribe((response:object) => {
