...
@NgModule({
  imports: [
    PATTERN_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, PatternDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
