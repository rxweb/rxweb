...
@NgModule({
  imports: [
    FACTOR_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, FactorDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
