...
@NgModule({
  imports: [
    MAC_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, MacDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
