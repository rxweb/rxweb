...
@NgModule({
  imports: [
    DIGIT_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, DigitDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
