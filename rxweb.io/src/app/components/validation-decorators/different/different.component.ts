...
import { DifferentCompleteComponent } from '../../../../assets/examples/different/complete/different-complete.component';
...
export class DifferentComponent implements OnInit {
  ...
  ngOnInit(): void {
	this.http.get('assets/examples/different/different.json',this.options).subscribe((response:object) => {
