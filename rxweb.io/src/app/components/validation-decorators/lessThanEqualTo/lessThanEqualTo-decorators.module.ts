...
@NgModule({
  imports: [
    ...
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, LessThanEqualToDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
