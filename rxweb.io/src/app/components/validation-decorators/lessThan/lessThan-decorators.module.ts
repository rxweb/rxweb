...
@NgModule({
  imports: [
    LESS_THAN_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, LessThanDecoratorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
