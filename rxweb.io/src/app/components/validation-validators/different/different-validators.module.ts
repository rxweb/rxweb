...
@NgModule({
  imports: [
    DIFFERENT_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, DifferentValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
