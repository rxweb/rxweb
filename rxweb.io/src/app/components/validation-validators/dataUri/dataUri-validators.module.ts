...
@NgModule({
  imports: [
    DATA_URI_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, DataUriValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
