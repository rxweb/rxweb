...
@NgModule({
  imports: [
    COMPARE_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, CompareValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
