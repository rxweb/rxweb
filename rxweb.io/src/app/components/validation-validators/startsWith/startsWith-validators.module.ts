...
@NgModule({
  imports: [
    STARTS_WITH_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, StartsWithValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
