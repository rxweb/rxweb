...
@NgModule({
  imports: [
    FACTOR_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, FactorValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
...
export class FactorValidatorsModule { }
