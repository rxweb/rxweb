...
@NgModule({
  imports: [
    ASCII_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, AsciiValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
