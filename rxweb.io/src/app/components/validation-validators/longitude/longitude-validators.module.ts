...
@NgModule({
  imports: [
    LONGITUDE_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, LongitudeValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule,PipeCommonModule],
