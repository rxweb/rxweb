...
@NgModule({
  imports: [
    EMAIL_ROUTING,
    CommonModule, FormsModule, ReactiveFormsModule, HighlightModule, EmailValidatorsExtendedModule, ClipboardModule,DisqusSharedModule,RightSideBarSharedModule],
