...
export class FileSizeComponent implements OnInit {
  ...
  ngOnInit(): void {
	this.http.get('assets/examples/reactive-form-validators/validators/fileSize/filesize.json',this.options).subscribe((response:object) => {
