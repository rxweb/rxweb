            ...
            for (let /** @type {?} */ columnName in this.configs) {
                if (!Array.isArray(this.configs[columnName])) {
                    ...
                    if ((descriptor && descriptor.get) || this.configs[columnName].isFilterFunction) {
                        let /** @type {?} */ stringFunction = this.configs[columnName].isFilterFunction ? String(this.configs[columnName][FILTER$1]) : String(descriptor.get);
...
class RxDynamicFormBuilder {
    ...
    formGroup(fields, dynamicFormConfig) {
        ...
        fields.forEach((x, i) => {
            if (x.type == ARRAY) {
                this.createFormArray(modelConfig, x, /** @type {?} */ (ApplicationUtil$1.getRootFormGroup(formGroup)), entityObject);
            }
            else {
    ...
    getModelInstance(x, modelConfig) {
        ...
        let /** @type {?} */ modelInstance = getInstance$1(model$$1, modelArguments);
...
class ElementEventProcessor extends ElementAccessor {
     ...
     */
    setBlur() {
        let /** @type {?} */ listen = this.dynamicNodeConfig.renderer.listen(this.element, BLUR$1, () => {
     ...
     */
    setInput() {
        let /** @type {?} */ listen = this.dynamicNodeConfig.renderer.listen(this.element, INPUT$1, (v) => {
...
class RxDynamicFormDirective extends ControlConfigProcessor {
    /**
     * @param {?} elementRef
     * @param {?} renderer
     */
...
class RxReactiveDynamicFormsModule {
    /**
     * @return {?}
     */
...
//# sourceMappingURL=reactive-dynamic-forms.js.map
