...
(function() {
  describe('RxwebValidators', () => {
    ...
    describe('range', () => {
	      ...
	      it("Should not error, If you want to apply conditional validation on 'Project Duration' or 'Employee Experience', then you need to add 'Employee Age' input greater than 25",
        () => { 
          expect(RxwebValidators.range({minimumNumber:18,maximumNumber:60})(new FormControl(20))).toBeNull(); 
        });


      it("Should error, If you want to apply conditional validation on 'Project Duration' or 'Employee Experience', then you need to add 'Employee Age' input greater than 25",
        () => { 
...
'age':[20],
      ...
      it("Should not error, Please enter salary between 1000 to 200000",
        () => { 
      ...
      it("Should error, Please enter salary between 1000 to 200000",
        () => { 
