...
(function() {
  describe('RxwebValidators', () => {
    ...
    describe('greaterThanEqualTo', () => {
        ...
        () => { 
          expect(RxwebValidators.greaterThanEqualTo()(new FormControl(''))).toBeNull();
        });
	
      it('should not error on null.',
        () => { 
          expect(RxwebValidators.greaterThanEqualTo()(new FormControl(null))).toBeNull();
        });
	
      it('should not error on undefined.',
        () => { 
          expect(RxwebValidators.greaterThanEqualTo()(new FormControl(undefined))).toBeNull(); 
        });
