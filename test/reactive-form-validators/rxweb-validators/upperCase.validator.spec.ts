...
(function() {
  describe('RxwebValidators', () => {
    ...
    describe('upperCase', () => {
      ...
      it("Should not error, Enter the 'INDIA' in 'Country Name' or 'City Name' text box to see the validation in 'State Name' text box.",
        () => { 
          expect(RxwebValidators.upperCase()(new FormControl('INDIA'))).toBeNull(); 
        });


      it("Should error, Enter the 'INDIA' in 'Country Name' or 'City Name' text box to see the validation in 'State Name' text box.",
        () => { 
