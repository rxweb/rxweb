...
describe('FormControlConfig Properties', () => {
    ...
    describe('description', () => {
        ...
        it('description should be undefined.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'description', model: DescriptionModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }], tagName: 'input' })
        ...
        it('description text should be "Enter your First Name".', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'description', model: DescriptionModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox", ui: { description: 'Enter your First Name' } }], tagName: 'input' })
        ...
        it('LastName input element description should be "Enter your Last Name".', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'description', model: DescriptionModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }, { name: "lastName", type: "textbox", actionKeyNames: ["onlyDescription"], modelName: 'description' }], tagName: 'input', uiBindings: ['firstName', 'lastName'] })
