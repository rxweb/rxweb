...
describe('FormControlConfig Properties', () => {
    ...
    describe('disable', () => {
        ...
        it('LastName FormControl should not be disabled.', fakeAsync(() => {
            let options = inputProcessor({ component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }, { name: "lastName", type: "textbox", actionKeyNames: ["onlyDisable"], modelName: 'disable' }], tagName: 'input' })
        ...
        it('LastName FormControl should be disabled when firstName value is "ajay".', fakeAsync(() => {
            let options = inputProcessor({ component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }, { name: "lastName", type: "textbox", actionKeyNames: ["onlyDisable"], modelName: 'disable' }], tagName: 'input', uiBindings:['firstName','lastName'] })
            expect(options.instance.dynamicFormBuildConfig.controlsConfig.lastName.disable).toBeFalsy();
