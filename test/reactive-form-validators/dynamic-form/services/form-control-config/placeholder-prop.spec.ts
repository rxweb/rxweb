...
describe('FormControlConfig Properties', () => {
    ...
    describe('placeholder', () => {
        ...
        it('placeholder should be undefined.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'placeholder', model: PlaceholderModel }] },  component: BindingComponent, serverData: [{ name: "firstName", type: "textbox"}], tagName: 'input' })
        ...
        it('placeholder text should be "Enter your First Name".', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'placeholder', model: PlaceholderModel }] },  component: BindingComponent, serverData: [{ name: "firstName", type: "textbox", ui: { placeholder: 'Enter your First Name' } }], tagName: 'input' })
        ...
        it('LastName input element placeholder should be "Enter your Last Name".', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'placeholder', model: PlaceholderModel }] },  component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }, { name: "lastName", type: "textbox", actionKeyNames: ["onlyPlaceholder"], modelName: 'placeholder' }], tagName: 'input', uiBindings: ['firstName', 'lastName'] })
