...
describe('FormControlConfig Properties', () => {
    ...
    describe('readonly', () => {
        ...
        it('readonly should be undefined.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'readonly', model: ReadonlyModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }], tagName: 'input' })
        ...
        it('readonly should be true.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'readonly', model: ReadonlyModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox", ui: { readonly: true } }], tagName: 'input' })
        ...
        it('LastName input element readonly should be false.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'readonly', model: ReadonlyModel }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox" }, { name: "lastName", type: "textbox", actionKeyNames: ["onlyReadonly"], modelName: 'readonly' }], tagName: 'input', uiBindings: ['firstName', 'lastName'] })
