...
describe('FormControlConfig Properties', () => {
    ...
    describe('value', () => {
        ...
        it('should work with the value is null.', fakeAsync(() => {
            let options = inputProcessor({ component: BindingComponent, serverData: [{ name: "firstName", type: "textbox",value:null }], tagName: 'input' })
        ...
        it('should work with the value is undefined.', fakeAsync(() => {
            let options = inputProcessor({ component: BindingComponent, serverData: [{ name: "firstName", type: "textbox", value: undefined }], tagName: 'input' })
            expect(options.element.value).toEqual("");
            expect(options.instance.dynamicFormBuildConfig.formGroup.controls.firstName.value).toBeNull();
        ...
        it('Conditionally change FormControl value.', fakeAsync(() => {
            let options = inputProcessor({ dynamicFormConfiguration: { fieldConfigModels: [{ modelName: 'value' }] }, component: BindingComponent, serverData: [{ name: "firstName", type: "textbox", value: null, modelName: 'value' }, { name: "lastName", type: "textbox", value: null }], tagName: 'input' })
