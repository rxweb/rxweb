...
export class BuyerFurnishedMaterialBase {
...
//#region vendorAdjustable Prop
        @prop()
        vendorAdjustable : boolean;
//#endregion vendorAdjustable Prop


//#region requireConfirmation Prop
        @prop()
        requireConfirmation : boolean;
//#endregion requireConfirmation Prop
