...
//#region stockManufacture Prop
        @maxLength({value:4000})
        stockManufacture : string;
//#endregion stockManufacture Prop
...
//#region rollOrientationId Prop
        @prop()
        rollOrientationId : number;
//#endregion rollOrientationId Prop


//#region rollWarningsStripe Prop
        @prop()
        rollWarningsStripe : any;
//#endregion rollWarningsStripe Prop
...
//#region stateForeignSuppressions Prop
        @maxLength({value:4000})
        stateForeignSuppressions : string;
...
//#region cretaedDateTime Prop
        @prop()
        cretaedDateTime : any;
//#endregion cretaedDateTime Prop
