import {SpecItemCurrentStatusBase} from '../database-models/spec-item-current-status-base';
...
//Generated Imports
export class SpecItemCurrentStatus extends SpecItemCurrentStatusBase 
{
