...
namespace NewProjectSolution.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(NewProjectSolution.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(NewProjectSolution.Models.Main.LanguageContent.ComponentLanguageContents))]
