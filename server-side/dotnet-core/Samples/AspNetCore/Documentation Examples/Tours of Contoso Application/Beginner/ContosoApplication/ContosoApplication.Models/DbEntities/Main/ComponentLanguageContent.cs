...
namespace ContosoApplication.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(ContosoApplication.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(ContosoApplication.Models.Main.LanguageContent.ComponentLanguageContents))]
