...
namespace HumanResourceApplication.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(HumanResourceApplication.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(HumanResourceApplication.Models.Main.LanguageContent.ComponentLanguageContents))]
