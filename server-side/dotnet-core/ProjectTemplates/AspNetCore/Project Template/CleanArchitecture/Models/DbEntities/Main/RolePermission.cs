...
namespace $ext_safeprojectname$.Models.Main
{
    ...
    public partial class RolePermission
    {
        ...
        [InverseProperty(nameof($ext_safeprojectname$.Models.Main.ApplicationModule.RolePermissions))]
        ...
        [InverseProperty(nameof($ext_safeprojectname$.Models.Main.Role.RolePermissions))]
