...
To know more, please refer to the [basic example](https://stackblitz.com/edit/rxweb-translate-basic-example?file=src%2Fapp%2Fuser.component.ts) or refer to the articles on [Medium](https://medium.com/@oojhaajay)
