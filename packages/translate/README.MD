...
## @Translate
Translate decorator is used to create a multilingualContent object and resolve multilingual data based upon the given translation name.
...
Here is the HTML.
```Html
  <mark>{{multilingualContent.get("text.userName")}}</mark>
```
