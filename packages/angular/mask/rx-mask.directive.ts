import {Component, ElementRef, AfterViewInit, OnDestroy, Input, forwardRef, Output, EventEmitter} from '@angular/core';
...
@Component({
    selector: 'rx-mask',
    template: `<input  [value]="value||''" [attr.type]="type"  [ngStyle]="style" [ngClass]="styleClass" [attr.placeholder]="placeholder"
        [attr.size]="size" [attr.name]="name" [attr.maxlength]="maxlength" [attr.tabindex]="tabindex" [disabled]="disabled" [readonly]="readonly"
...
@NgModule({
    ...
    exports: [RxMaskDirective],
    declarations: [RxMaskDirective]
})
export class RxMaskModule { }
