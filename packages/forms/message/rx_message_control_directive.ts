import {ContentChildren, Inject, OnInit, OnDestroy,
    QueryList, HostListener,
    Directive, Input, Output, AfterViewInit, Renderer, ElementRef, Component, forwardRef, OnChanges, ViewContainerRef, ComponentFactoryResolver, ComponentFactory} from "@angular/core";
...
this.setOverlay(cssClass);
    ...
    validate(formControl: FormControl): boolean {
        ...
        if (!this.isSubscribed) {
            ...
            formControl.statusChanges.subscribe(v => this.statusChange(v, formControl));
